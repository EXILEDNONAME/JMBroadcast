...
class Video3Controller extends Controller {
  ...
  public function index(){
    $data = Video::where('status', 3)->get();
    return view('pages.dashboard.setup.video-3.index', compact('data'));
  }

  public function upload(){
    return view('pages.dashboard.setup.video-3.upload');
  }
  ...
  public function process(Request $request){
    ...
    return redirect('/dashboard/setups/video-3')->with('success', 'Success Upload File.');
  }
  ...
  public function active($id) {
    ...
    return redirect('dashboard/setups/video-3')->with('success', 'Success, switching video to active.');
  }

  public function nonactive($id) {
    DB::table('videos')->where('id', $id)->update([ 'active' => 2 ]);
    return redirect('/dashboard/setups/video-3')->with('success', 'Success, switching video to non-active.');
  }
