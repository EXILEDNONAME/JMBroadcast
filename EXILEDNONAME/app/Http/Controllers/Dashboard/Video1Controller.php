...
class Video1Controller extends Controller {
  ...
  public function index(){
    ...
    return view('pages.dashboard.setup.video-1.index', compact('data'));
  }

  public function upload(){
    return view('pages.dashboard.setup.video-1.upload');
  }
  ...
  public function process(Request $request){
    ...
    return redirect('/dashboard/setups/video-1')->with('success', 'Success Upload File.');
  }
  ...
  public function destroy($id) {
    ...
    return redirect('dashboard/setups/video-1')->with('success', 'Success, video has been removed.');
  }
  ...
  public function active($id) {
    ...
    return redirect('dashboard/setups/video-1')->with('success', 'Success, switching video to active.');
  }

  public function nonactive($id) {
    DB::table('videos')->where('id', $id)->update([ 'active' => 2 ]);
    return redirect('/dashboard/setups/video-1')->with('success', 'Success, switching video to non-active.');
  }
