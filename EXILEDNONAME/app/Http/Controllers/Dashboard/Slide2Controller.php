...
class Slide2Controller extends Controller {
  ...
  public function index(){
    $data = Image::where('status', 2)->get();
    return view('pages.dashboard.setup.slide-2.index', compact('data'));
  }

  public function upload(){
    return view('pages.dashboard.setup.slide-2.upload');
  }
  ...
  public function process(Request $request){
    ...
    return redirect('/dashboard/setups/slide-2')->with('success', 'Success Upload File.');
  }
  ...
  public function destroy($id) {
    ...
    return redirect('dashboard/setups/slide-2')->with('success', 'Success, image has been removed.');
  }
  ...
  public function active($id) {
    ...
    return redirect('dashboard/setups/slide-2')->with('success', 'Success, switching image to active.');
  }

  public function nonactive($id) {
    DB::table('images')->where('id', $id)->update([ 'active' => 2 ]);
    return redirect('/dashboard/setups/slide-2')->with('success', 'Success, switching image to non-active.');
  }
