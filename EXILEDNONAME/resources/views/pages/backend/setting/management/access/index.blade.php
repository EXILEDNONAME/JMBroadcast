    ...
    <thead>
      <tr>
        ...
        <th width="1%" class="text-nowrap"> Sort </th>
				<th width="1%" class="text-nowrap"> Created At </th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> {{ $item->sort }} </td>
				...
				<td> @include('controller.datatable.active') </td>
        <td> @include('controller.datatable.action') </td>
      </tr>
      @endforeach
    </tbody>
  </table>
