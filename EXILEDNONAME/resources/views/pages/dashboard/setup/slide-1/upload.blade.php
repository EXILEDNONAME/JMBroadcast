...
@section('page-description', '// Slide 1 Uploader ...')

@section('content')
<form action="/dashboard/setups/slide-1/upload/process" method="POST" enctype="multipart/form-data">
  {{ csrf_field() }}
<table width="100%" class="table table-condensed">
  ...
  <tr>
    ...
    <td width="75%" class="text-nowrap align-middle">
      ...
      <a href="/dashboard/setups/slide-1"><button type="cancel" class="btn btn-danger"> Cancel </button></a>
    </td>
  </tr>
</table>
</form>
