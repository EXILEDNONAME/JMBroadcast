...
@section('page-header', 'Slide 1')
@section('page-description', '// Index From Slide 1 ...')
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-nowrap align-middle text-center">
          @if ( $item->active == 1 ) <a href="/dashboard/setups/slide-1/nonactive/{{ $item->id }}"><span class="label label-success"> Yes </span></a> @endif
          @if ( $item->active == 2 ) <a href="/dashboard/setups/slide-1/active/{{ $item->id }}"><span class="label label-inverse"> No </span></a> @endif
        </td>
        <td class="text-nowrap align-middle text-center">
          ...
          <form method="POST" action="{{ url('dashboard/setups/slide-1' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
            {{ method_field('DELETE') }}
            {{ csrf_field() }}
