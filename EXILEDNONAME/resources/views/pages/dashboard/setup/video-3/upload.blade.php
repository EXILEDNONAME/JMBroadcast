...
@section('page-description', '// Video 3 Uploader ...')

@section('content')
<form action="/dashboard/setups/video-3/upload/process" method="POST" enctype="multipart/form-data">
  {{ csrf_field() }}
<table width="100%" class="table table-condensed">
  ...
  <tr>
    ...
    <td width="75%" class="text-nowrap align-middle">
      ...
      <a href="/dashboard/setups/video-1"><button type="cancel" class="btn btn-danger"> Cancel </button></a>
    </td>
  </tr>
</table>
</form>
