...
@section('page-header', 'Video Uploader')
@section('page-description', '// ...')

@section('content')
<form action="/dashboard/galleries/uploads/videos/process" method="POST" enctype="multipart/form-data">
  {{ csrf_field() }}
<table width="100%" class="table table-condensed">
  ...
  <tr class="form-group {{ $errors->has('order') ? 'has-error' : ''}}">
    ...
    <td width="1%" class="text-nowrap align-middle"> : </td>
    <td width="75%">
      <input type="number" class="form-control" name="sort" value="{{ GetCountVideo() }}">
    </td>
  </tr>
