...
(function($){
	...
	theme = {
		...
		----------------------------*/
	 	_init : function(){
			...
			$('#slidecaption,.coverphoto-outer-wrap').fadeIn('slow');
	...
	*/
		...
		// titles animation
			...
			$('#slidecaption,.coverphoto-outer-wrap').fadeOut('fast', function() {
		  	/* Update Fields
		  	----------------------------*/
		...
		----------------------------*/
	 	afterAnimation : function(){
			$('#slidecaption,.coverphoto-outer-wrap').fadeIn();
